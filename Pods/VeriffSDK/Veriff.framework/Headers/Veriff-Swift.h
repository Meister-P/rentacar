...
SWIFT_CLASS("_TtC6Veriff19AlertViewController")
...
SWIFT_CLASS("_TtC6Veriff17PresentrAnimation")
...
SWIFT_CLASS("_TtC6Veriff24CoverFromCornerAnimation")
@interface CoverFromCornerAnimation : PresentrAnimation
@end


SWIFT_CLASS("_TtC6Veriff24CoverHorizontalAnimation")
@interface CoverHorizontalAnimation : PresentrAnimation
@end


SWIFT_CLASS("_TtC6Veriff22CoverVerticalAnimation")
@interface CoverVerticalAnimation : PresentrAnimation
@end


SWIFT_CLASS("_TtC6Veriff29CoverVerticalFromTopAnimation")
@interface CoverVerticalFromTopAnimation : PresentrAnimation
@end


SWIFT_CLASS("_TtC6Veriff22CrossDissolveAnimation")
@interface CrossDissolveAnimation : PresentrAnimation
@end


SWIFT_CLASS("_TtC6Veriff23FlipHorizontalAnimation")
...
SWIFT_CLASS("_TtC6Veriff8Presentr")
...
@interface Presentr (SWIFT_EXTENSION(Veriff)) <UIViewControllerTransitioningDelegate>
...
@interface PresentrAnimation (SWIFT_EXTENSION(Veriff)) <UIViewControllerAnimatedTransitioning>
...
SWIFT_PROTOCOL("_TtP6Veriff16PresentrDelegate_")
...
SWIFT_CLASS("_TtC6Veriff26VeriffNavigationController")
@interface VeriffNavigationController : UINavigationController
- (void)viewDidLoad;
